...
export default function VenueOperationsLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await loginWithRole(formData, "venue_operator", "/venue-operations");
      ...
      >
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm sm:p-10">
          <div className="mb-8 text-center">
            <h1 className="text-[28px] font-semibold tracking-tight text-black">Sign in to Venue Ops</h1>
